...
{
      17,     0,    -1,    17,    18,    -1,    -1,     4,    11,    19,
      12,    -1,     4,    11,    13,     5,    13,    12,    -1,    14,
      19,    15,    -1,    19,     7,    19,    -1,    19,     8,    19,
      -1,    19,     9,    19,    -1,    19,    10,    19,    -1,     4,
      -1,     3,    -1
};
...
{
       0,   102,   102,   103,   106,   119,   132,   133,   141,   149,
     157,   165,   166
};
#endif
...
{
  "$end", "error", "$undefined", "NUMBER", "KEY", "STRING", "IncludeCfg",
  "'+'", "'-'", "'*'", "'/'", "'='", "'\\n'", "'\"'", "'('", "')'",
  "$accept", "config", "config_line", "expr", YY_NULL
};
#endif
...
{
       6,     7,     6,     7,     2,     5,    11,    24,     3,    18,
       8,     9,     0,     9,    13,    14,    15,    16,     0,    12,
       0,     0,    19,    20,    21,    22,    23,    13,    14,    15,
      16,     0,    17
};
...
{
       3,     4,     3,     4,     0,    11,     5,    12,     4,    13,
      13,    14,    -1,    14,     7,     8,     9,    10,    -1,     9,
      -1,    -1,    15,    13,    14,    15,    16,     7,     8,     9,
      10,    -1,    12
};
...
{
       0,    17,     0,     4,    18,    11,     3,     4,    13,    14,
      19,     5,    19,     7,     8,     9,    10,    12,    13,    15,
      19,    19,    19,    19,    12
};
...
#line 107 "config.y"
    {
				int index = var_name_to_nenum((yyvsp[(1) - (4)].sval));
				if (index)
				{
					nsym[index] = (yyvsp[(3) - (4)].nval); 
					printf("%s = ", (yyvsp[(1) - (4)].sval));
					print(nsym[var_name_to_nenum((yyvsp[(1) - (4)].sval))]);
					printf("\n");
				}
				else
...
#line 120 "config.y"
    { 
				int index = var_name_to_senum((yyvsp[(1) - (6)].sval));
				if (index)
				{	
					ssym[index] = (yyvsp[(4) - (6)].sval); 
					printf("%s = \"%s\"\n", (yyvsp[(1) - (6)].sval), ssym[var_name_to_senum((yyvsp[(1) - (6)].sval))]);
				}
				else
					yyerror("Unkown parameter!");
			}
...
#line 134 "config.y"
    { 
			(yyval.nval).type = (yyvsp[(1) - (3)].nval).type || (yyvsp[(3) - (3)].nval).type; 
			if (!(yyval.nval).type) 
				(yyval.nval).d = ((yyval.nval).l = (yyvsp[(1) - (3)].nval).l + (yyvsp[(3) - (3)].nval).l); 
			else
				(yyval.nval).d = (yyvsp[(1) - (3)].nval).d + (yyvsp[(3) - (3)].nval).d;
		}
    break;
...
/* Line 1787 of yacc.c  */
#line 165 "config.y"
    { (yyval.nval) = nsym[var_name_to_nenum((yyvsp[(1) - (1)].sval))]; }
    break;
